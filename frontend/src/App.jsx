    ...
    try {
      ...
      if (analysis && !analysis.error) {
        ...
        setMessages(prev => [...prev, {
          id: Date.now() + 1,
          role: 'assistant',
          content: `Photo received but analysis unavailable. ${analysis.observations || 'Continuing with your description.'}`,
          isAnalysis: true
        }])
      ...
      if (analysis.error) {
        // Analysis failed - let the AI know to continue without image
        sendMessage(`I tried to share a photo but the analysis couldn't be completed. Please continue assessing based on my description.`)
      } else {
            ...
            <div style={{ flex: 1, position: "relative" }}>
              <textarea
                ...
                onKeyDown={e => {
                  if (e.key === 'Enter') {
                    ...
                    // No preventDefault, so textarea naturally handles newline
                  }
                }}
              ...
              {input.length > 0 && (
                <div style={{
                  ...
                  <span style={{ opacity: 0.4 }}>⌘↵ to send</span>
                </div>
              )}
            </div>
